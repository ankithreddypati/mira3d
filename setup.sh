...
# echo "Installing ffmpeg , imagemagick, colmap with cuda"
...
# # Check CUDA architecture (adjust 89 based on your GPU)
...
# echo "Setup complete! COLMAP with CUDA support is ready."
...
echo "🖌️ Cloning and building Brush..."
